  ...
  return (
    <footer className="bg-[#F3F6Fa]">
        ...
        <div className="w-3/12 lg:w-4/12 sm:w-full">
          <div className="flex flex-col gap-3">
            <img
              ...
              src="https://toko-client.vercel.app/images/logo.png"
              alt="logo"
            />
            <ul className="flex flex-col gap-2 text-slate-600">
              <li>Address :Indonesia , Jakarta </li>
              <li>Phone : 085891088596</li>
              <li>Email : ramadifan769@gmail.com</li>
            </ul>
          </div>
        </div>
      ...
      <div className="w-[85%] flex flex-wrap justify-center items-center text-slate-600 mx-auto py-5 text-center">
        <span>
          Copiright ©2024 All rights reserved | mady by{" "}
