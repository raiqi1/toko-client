...
const Card = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://toko-client.vercel.app/images/banner/card.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
                            ...
                            <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                              <div className="pl-4 sm:pl-0">
                                ...
                                <p className="line-through">
                                  {formatToRupiah(pt.productInfo.price)}
                                </p>
                            ...
                            <div key={i} className="w-full flex flex-wrap">
                              ...
                              <div className="flex justify-between w-5/12 sm:w-full sm:mt-3">
                                <div className="pl-4 sm:pl-0">
                                  ...
                                  <p className="line-through">
                                    {formatToRupiah(p.products[0].price)}
                                  </p>
                  ...
                  {card_products.length > 0 && (
                    <div className="bg-white p-3 text-slate-600 flex flex-col gap-3">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span>{formatToRupiah(shipping_fee)}</span>
                      </div>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        {formatToRupiah(price + shipping_fee)}
                        </span>
                      </div>
                      <button
                        onClick={redirect}
