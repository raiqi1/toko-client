...
const CategoryShops = () => {
  ...
  return (
    <div>
      <Headers />
      <section className='bg-[url("https://toko-client.vercel.app/images/banner/shop.gif")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            ...
            >
              <div className="py-2 flex flex-col gap-5">
                ...
                <div>
                  ...
                  {formatToRupiah(Math.floor(state.values[0]))} -{" "}
                    {formatToRupiah(Math.floor(state.values[1]))}
                  </span>
                </div>
              </div>
