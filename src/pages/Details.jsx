...
const Details = () => {
  ...
  return (
    <div>
      <Headers />
      <div className='bg-[url("https://toko-client.vercel.app/images/banner/order.jpg")] h-[220px] mt-6 bg-cover bg-no-repeat relative bg-left'>
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="text-2xl text-red-500 font-bold flex gap-3">
                {product.discount !== 0 ? (
                  ...
                  <h2>Price : {formatToRupiah(product.price)}</h2>
                )}
              </div>
                  ...
                  {moreProducts.map((p, i) => {
                    return (
                      <Link
                        ...
                        onClick={(e) => {
                          dispatch(get_product(p.slug));
                          const offset = 800; // Sesuaikan dengan jumlah pixel yang diinginkan
